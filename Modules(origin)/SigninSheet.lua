...
--奖励分类
local rewards_list = {};
rewards_list[1] = {"伏特能量",631092,50};
rewards_list[2] = {"伏特能量",631092,50};
rewards_list[3] = {"伏特能量",631092,50};
rewards_list[4] = {"伏特能量",631092,50};
rewards_list[5] = {"伏特能量",631092,50};
rewards_list[6] = {"神奇扭蛋",47824,10};
rewards_list[7] = {"神奇扭蛋",47824,10};
--剩余次数计算
