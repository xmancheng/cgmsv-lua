...
local DrawTbl={
       ...
       { Num="005", type="A", serial_L=978, serial_H=984, name="蛇人魯夫召喚書", itemid=910272, count=1},        --A(5~7)
       { Num="006", type="A", serial_L=971, serial_H=977, name="天女獸召喚書", itemid=910273, count=1},
       { Num="007", type="A", serial_L=964, serial_H=970, name="天使女獸召喚書", itemid=910274, count=1},
       { Num="008", type="B", serial_L=944, serial_H=963, name="大龍魂碎片箱", itemid=631095, count=1},        --B(8~10)
       { Num="009", type="B", serial_L=924, serial_H=943, name="中龍魂碎片箱", itemid=631094, count=1},
       { Num="010", type="B", serial_L=904, serial_H=923, name="小龍魂碎片箱", itemid=631093, count=1},
