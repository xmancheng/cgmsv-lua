---模块类
local Module = ModuleBase:createModule(forgingPlans3)
...
--
forging_plan_name[1] = "芙蕾亞之劍LV1";
forging_plan_offering[1] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[1] = {70052};
forging_plan_gold[1] =250000;
forging_plan_thing[1] = {70006,70006,70006,70006,70006,70006,70006,70006,70006,70006};
forging_plan_grade[1] =1;

forging_plan_name[2] = "芙蕾亞之斧LV1";
forging_plan_offering[2] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[2] = {70052};
forging_plan_gold[2] =250000;
forging_plan_thing[2] = {70009,70009,70009,70009,70009,70009,70009,70009,70009,70009};
forging_plan_grade[2] =1;

forging_plan_name[3] = "芙蕾亞之槍LV1";
forging_plan_offering[3] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[3] = {70052};
forging_plan_gold[3] =250000;
forging_plan_thing[3] = {70012,70012,70012,70012,70012,70012,70012,70012,70012,70012};
forging_plan_grade[3] =1;

forging_plan_name[4] = "芙蕾亞之弓LV1";
forging_plan_offering[4] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[4] = {70052};
forging_plan_gold[4] =250000;
forging_plan_thing[4] = {70015,70015,70015,70015,70015,70015,70015,70015,70015,70015};
forging_plan_grade[4] =1;

forging_plan_name[5] = "芙蕾亞之杖LV1";
forging_plan_offering[5] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[5] = {70052};
forging_plan_gold[5] =250000;
forging_plan_thing[5] = {70018,70018,70018,70018,70018,70018,70018,70018,70018,70018};
forging_plan_grade[5] =1;

forging_plan_name[6] = "芙蕾亞迴力鏢LV1";
forging_plan_offering[6] = {{71047,1},{70058,1},{70059,10}};
forging_plan_item[6] = {70052};
forging_plan_gold[6] =250000;
forging_plan_thing[6] = {70021,70021,70021,70021,70021,70021,70021,70021,70021,70021};
forging_plan_grade[6] =1;

forging_plan_name[7] = "芙蕾亞小刀LV1";
forging_plan_offering[7] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[7] = {70052};
forging_plan_gold[7] =250000;
forging_plan_thing[7] = {70024,70024,70024,70024,70024,70024,70024,70024,70024,70024};
forging_plan_grade[7] =1;

forging_plan_name[8] = "芙蕾亞之拳LV1";
forging_plan_offering[8] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[8] = {70052};
forging_plan_gold[8] =250000;
forging_plan_thing[8] = {70027,70027,70027,70027,70027,70027,70027,70027,70027,70027};
forging_plan_grade[8] =1;

forging_plan_name[9] = "芙蕾亞之帽LV1";
forging_plan_offering[9] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[9] = {70055};
forging_plan_gold[9] =250000;
forging_plan_thing[9] = {70030,70030,70030,70030,70030,70030,70030,70030,70030,70030};
forging_plan_grade[9] =1;

forging_plan_name[10] = "芙蕾亞之服LV1";
forging_plan_offering[10] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[10] = {70055};
forging_plan_gold[10] =250000;
forging_plan_thing[10] = {70033,70033,70033,70033,70033,70033,70033,70033,70033,70033};
forging_plan_grade[10] =1;

forging_plan_name[11] = "芙蕾亞之袍LV1";
forging_plan_offering[11] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[11] = {70055};
forging_plan_gold[11] =250000;
forging_plan_thing[11] = {70036,70036,70036,70036,70036,70036,70036,70036,70036,70036};
forging_plan_grade[11] =1;

forging_plan_name[12] = "芙蕾亞鎧甲LV1";
forging_plan_offering[12] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[12] = {70055};
forging_plan_gold[12] =250000;
forging_plan_thing[12] = {70039,70039,70039,70039,70039,70039,70039,70039,70039,70039};
forging_plan_grade[12] =1;

forging_plan_name[13] = "芙蕾亞之盔LV1";
forging_plan_offering[13] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[13] = {70055};
forging_plan_gold[13] =250000;
forging_plan_thing[13] = {70042,70042,70042,70042,70042,70042,70042,70042,70042,70042};
forging_plan_grade[13] =1;

forging_plan_name[14] = "芙蕾亞之靴LV1";
forging_plan_offering[14] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[14] = {70055};
forging_plan_gold[14] =250000;
forging_plan_thing[14] = {70046,70046,70046,70046,70046,70046,70046,70046,70046,70046};
forging_plan_grade[14] =1;

forging_plan_name[15] = "芙蕾亞之鞋LV1";
forging_plan_offering[15] = {{71047,1},{70058,1},{70059,10}}
forging_plan_item[15] = {70055};
forging_plan_gold[15] =250000;
forging_plan_thing[15] = {70049,70049,70049,70049,70049,70049,70049,70049,70049,70049};
forging_plan_grade[15] =1;
-------------------------------------------------
...
--远程按钮UI呼叫
function Module:forgingPlansInfo3(npc, player)
          ...
          NLG.ShowWindowTalked(player, self.forgingerNPC3, CONST.窗口_选择框, winButton, 1, msg);
end

--- 加载模块钩子
function Module:onLoad()
  self:logInfo('load');
  self.forgingerNPC3 = self:NPC_createNormal('LV1武防提煉鍛造', 231136, { x = 216, y = 76, mapType = 0, map = 1000, direction = 0 });
  self:NPC_regWindowTalkedEvent(self.forgingerNPC3, function(npc, player, _seqno, _select, _data)
    ...
    if _select > 0 then
      if _select == CONST.按钮_确定 then
          if (page>=1001) then
              ...
              NLG.ShowWindowTalked(player, self.forgingerNPC3, CONST.窗口_信息框, CONST.按钮_是否, 2000+seqno, msg);
              return
          else
              return
          end
      ...
      local msg = "　　　　　　　　【武防提煉鍛造】\\n"
      local msg = msg .. forgingGoalInfo(count);
      NLG.ShowWindowTalked(player, self.forgingerNPC3, CONST.窗口_信息框, CONST.按钮_确定关闭, 1000+count, msg);
    end
  end)
  self:NPC_regTalkedEvent(self.forgingerNPC3, function(npc, player)
