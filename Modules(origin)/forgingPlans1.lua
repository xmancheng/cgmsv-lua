---模块类
local Module = ModuleBase:createModule(forgingPlans1)
...
--
forging_plan_name[1] = "芙蕾亞之劍LV3";
forging_plan_offering[1] = {{70007,1},{70058,1},{70059,10}};
forging_plan_item[1] = {70054};
forging_plan_gold[1] =250000;
forging_plan_thing[1] = {70007,70007,70007,70008,70008,70008,70008,70008,70008,70008};
forging_plan_grade[1] =3;

forging_plan_name[2] = "芙蕾亞之斧LV3";
forging_plan_offering[2] = {{70010,1},{70058,1},{70059,10}};
forging_plan_item[2] = {70054};
forging_plan_gold[2] =250000;
forging_plan_thing[2] = {70010,70010,70010,70011,70011,70011,70011,70011,70011,70011};
forging_plan_grade[2] =3;

forging_plan_name[3] = "芙蕾亞之槍LV3";
forging_plan_offering[3] = {{70013,1},{70058,1},{70059,10}};
forging_plan_item[3] = {70054};
forging_plan_gold[3] =250000;
forging_plan_thing[3] = {70013,70013,70013,70014,70014,70014,70014,70014,70014,70014};
forging_plan_grade[3] =3;

forging_plan_name[4] = "芙蕾亞之弓LV3";
forging_plan_offering[4] = {{70016,1},{70058,1},{70059,10}};
forging_plan_item[4] = {70054};
forging_plan_gold[4] =250000;
forging_plan_thing[4] = {70016,70016,70016,70017,70017,70017,70017,70017,70017,70017};
forging_plan_grade[4] =3;

forging_plan_name[5] = "芙蕾亞之杖LV3";
forging_plan_offering[5] = {{70019,1},{70058,1},{70059,10}};
forging_plan_item[5] = {70054};
forging_plan_gold[5] =250000;
forging_plan_thing[5] = {70019,70019,70019,70020,70020,70020,70020,70020,70020,70020};
forging_plan_grade[5] =3;

forging_plan_name[6] = "芙蕾亞迴力鏢LV3";
forging_plan_offering[6] = {{70022,1},{70058,1},{70059,10}};
forging_plan_item[6] = {70054};
forging_plan_gold[6] =250000;
forging_plan_thing[6] = {70022,70022,70022,70023,70023,70023,70023,70023,70023,70023};
forging_plan_grade[6] =3;

forging_plan_name[7] = "芙蕾亞小刀LV3";
forging_plan_offering[7] = {{70025,1},{70058,1},{70059,10}}
forging_plan_item[7] = {70054};
forging_plan_gold[7] =250000;
forging_plan_thing[7] = {70025,70025,70025,70026,70026,70026,70026,70026,70026,70026};
forging_plan_grade[7] =3;

forging_plan_name[8] = "芙蕾亞之拳LV3";
forging_plan_offering[8] = {{70028,1},{70058,1},{70059,10}}
forging_plan_item[8] = {70054};
forging_plan_gold[8] =250000;
forging_plan_thing[8] = {70028,70028,70028,70029,70029,70029,70029,70029,70029,70029};
forging_plan_grade[8] =3;

forging_plan_name[9] = "芙蕾亞之帽LV3";
forging_plan_offering[9] = {{70031,1},{70058,1},{70059,10}}
forging_plan_item[9] = {70057};
forging_plan_gold[9] =250000;
forging_plan_thing[9] = {70031,70031,70031,70032,70032,70032,70032,70032,70032,70032};
forging_plan_grade[9] =3;

forging_plan_name[10] = "芙蕾亞之服LV3";
forging_plan_offering[10] = {{70034,1},{70058,1},{70059,10}}
forging_plan_item[10] = {70057};
forging_plan_gold[10] =250000;
forging_plan_thing[10] = {70035,70035,70035,70035,70035,70035,70035,70035,70035,70035};
forging_plan_grade[10] =3;

forging_plan_name[11] = "芙蕾亞之袍LV3";
forging_plan_offering[11] = {{70037,1},{70058,1},{70059,10}}
forging_plan_item[11] = {70057};
forging_plan_gold[11] =250000;
forging_plan_thing[11] = {70037,70037,70037,70038,70038,70038,70038,70038,70038,70038};
forging_plan_grade[11] =3;

forging_plan_name[12] = "芙蕾亞鎧甲LV3";
forging_plan_offering[12] = {{70040,1},{70058,1},{70059,10}}
forging_plan_item[12] = {70057};
forging_plan_gold[12] =250000;
forging_plan_thing[12] = {70040,70040,70040,70041,70041,70041,70041,70041,70041,70041};
forging_plan_grade[12] =3;

forging_plan_name[13] = "芙蕾亞之盔LV3";
forging_plan_offering[13] = {{70043,1},{70058,1},{70059,10}}
forging_plan_item[13] = {70057};
forging_plan_gold[13] =250000;
forging_plan_thing[13] = {70043,70043,70043,70044,70044,70044,70044,70044,70044,70044};
forging_plan_grade[13] =3;

forging_plan_name[14] = "芙蕾亞之靴LV3";
forging_plan_offering[14] = {{70047,1},{70058,1},{70059,10}}
forging_plan_item[14] = {70057};
forging_plan_gold[14] =250000;
forging_plan_thing[14] = {70047,70047,70047,70048,70048,70048,70048,70048,70048,70048};
forging_plan_grade[14] =3;

forging_plan_name[15] = "芙蕾亞之鞋LV3";
forging_plan_offering[15] = {{70050,1},{70058,1},{70059,10}}
forging_plan_item[15] = {70057};
forging_plan_gold[15] =250000;
forging_plan_thing[15] = {70050,70050,70050,70051,70051,70051,70051,70051,70051,70051};
forging_plan_grade[15] =3;
-------------------------------------------------
...
--远程按钮UI呼叫
function Module:forgingPlansInfo1(npc, player)
          ...
          NLG.ShowWindowTalked(player, self.forgingerNPC1, CONST.窗口_选择框, winButton, 1, msg);
end
...
function Module:onLoad()
  ...
  self.forgingerNPC1 = self:NPC_createNormal('LV3武防提煉鍛造', 231136, { x = 238, y = 85, mapType = 0, map = 1000, direction = 0 });
  self:NPC_regWindowTalkedEvent(self.forgingerNPC1, function(npc, player, _seqno, _select, _data)
    ...
    if _select > 0 then
      if _select == CONST.按钮_确定 then
          if (page>=1001) then
              ...
              NLG.ShowWindowTalked(player, self.forgingerNPC1, CONST.窗口_信息框, CONST.按钮_是否, 2000+seqno, msg);
              return
          else
              return
          end
      ...
      local msg = "　　　　　　　　【武防提煉鍛造】\\n"
      local msg = msg .. forgingGoalInfo(count);
      NLG.ShowWindowTalked(player, self.forgingerNPC1, CONST.窗口_信息框, CONST.按钮_确定关闭, 1000+count, msg);
    end
  end)
  self:NPC_regTalkedEvent(self.forgingerNPC1, function(npc, player)
