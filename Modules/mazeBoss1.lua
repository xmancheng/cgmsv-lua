...
--     十(9)	八(7)	六(5)	七(6)	九(8)
------------对战NPC设置------------
EnemySet[1] = {400073, 400073, 400073, 400073, 400073, 400072, 400072, 400072, 400072, 400072}    --0代表没有怪
EnemySet[2] = {0, 400073, 400073, 0, 0, 406190, 0, 0, 400072, 400072}
EnemySet[3] = {0, 400073, 400073, 0, 0, 406190, 0, 0, 400072, 400072}
BaseLevelSet[1] = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100}
BaseLevelSet[2] = {0, 105, 105, 0, 0, 110, 0, 0, 105, 105}
BaseLevelSet[3] = {0, 105, 105, 0, 0, 110, 0, 0, 105, 105}
Pos[1] = {"迷藏蝙蝠",EnemySet[1],BaseLevelSet[1]}
Pos[2] = {"巨櫻樹王",EnemySet[2],BaseLevelSet[2]}
Pos[3] = {"巨櫻樹王",EnemySet[3],BaseLevelSet[3]}
------------------------------------------------
--背景设置
local Switch = 1;                          --组队人数限制开关1开0关
local Rank = 0;                             --初始化难度分类
local BossMap= {60003,40,9} -- 战斗场景Floor,X,Y(弱、普、超同场景)
...
function Module:onLoad()
  ...
  local Lord1Npc = self:NPC_createNormal('區域領主討伐', 11394, { map = 60002, x = 145, y = 28, direction = 6, mapType = 0 })
