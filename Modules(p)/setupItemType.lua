...
function Module:onLoad()
  ...
  local itemType = {
    ...
    { type=66, name="魔劍", defaultImage=20075, place=3, flags=0, job=15, level=10 },
    { type=67, name="陷阱", defaultImage=27938, place=3, flags=0, job=45, level=10 },
    { type=68, name="書籍", defaultImage=27446, place=3, flags=0, job=75, level=10 },
    { type=69, name="風魔", defaultImage=99521, place=3, flags=0, job=115, level=10 },
