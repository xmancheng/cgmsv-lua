          ...
          if (petIndex>=0) then
              ...
              if (bindId==0 and typeId==0 and typeLv==0) then
                 if (Char.ItemNum(player, 510222)>=100 and Char.ItemNum(player, 510233)>=100 and Char.ItemNum(player, 510244)>=100 and Char.ItemNum(player, 510255)>=100) then
                     ...
                     Item.SetData(PetCrystalIndex,CONST.道具_生命, Item.GetData(PetCrystalIndex,CONST.道具_生命)+250);
                     Item.SetData(PetCrystalIndex,CONST.道具_魔力, Item.GetData(PetCrystalIndex,CONST.道具_魔力)+250);
