--模块类
local Module = ModuleBase:createModule('hunterTask2')
...
hunter_list[1].name = "《浪陽島的聒噪鳥》";
hunter_list[1].level_min = 1;
hunter_list[1].level_max = 130;
hunter_list[1].limit = 3;
hunter_list[1].target[1] = {};
hunter_list[1].target[1].name = "聒噪鳥";
hunter_list[1].target[1].amount = 5;
hunter_list[1].reward.gold = 1600;
hunter_list[1].reward.lp = 0;
hunter_list[1].reward.fp = 0;
hunter_list[1].reward.ep = 1300;
hunter_list[1].reward.item[1] = {id=80008, name="訓練家連弩", amount=1,};

hunter_list[2] = {};
hunter_list[2].target = {}
hunter_list[2].reward = {};
hunter_list[2].reward.item = {};
hunter_list[2].name = "《浪陽的狩獵鳳蝶》";
hunter_list[2].level_min = 7;
hunter_list[2].level_max = 130;
hunter_list[2].limit = 3;
hunter_list[2].target[1] = {};
hunter_list[2].target[1].name = "狩獵鳳蝶";
hunter_list[2].target[1].amount = 10;
hunter_list[2].reward.gold = 1800;
hunter_list[2].reward.lp = 0;
hunter_list[2].reward.fp = 0;
hunter_list[2].reward.ep = 1500;
hunter_list[2].reward.item[1] = {id=80009, name="訓練家木杖", amount=1,};

hunter_list[3] = {};
hunter_list[3].target = {}
hunter_list[3].reward = {};
hunter_list[3].reward.item = {};
hunter_list[3].name = "《浪陽島的護城龍》";
hunter_list[3].level_min = 14;
hunter_list[3].level_max = 130;
hunter_list[3].limit = 3;
hunter_list[3].target[1] = {};
hunter_list[3].target[1].name = "護城龍";
hunter_list[3].target[1].amount = 15;
hunter_list[3].reward.gold = 2000;
hunter_list[3].reward.lp = 0;
hunter_list[3].reward.fp = 0;
hunter_list[3].reward.ep = 1700;
hunter_list[3].reward.item[1] = {id=80007, name="訓練家短刀", amount=1,};

hunter_list[4] = {};
hunter_list[4].target = {}
hunter_list[4].reward = {};
hunter_list[4].reward.item = {};
hunter_list[4].name = "《迷惑的再生草脈》";
hunter_list[4].level_min = 20;
hunter_list[4].level_max = 135;
hunter_list[4].limit = 5;
hunter_list[4].target[1] = {};
hunter_list[4].target[1].name = "美麗花";
hunter_list[4].target[1].amount = 30;
hunter_list[4].reward.gold = 2500;
hunter_list[4].reward.lp = 0;
hunter_list[4].reward.fp = 0;
hunter_list[4].reward.ep = 2000;
hunter_list[4].reward.item[1] = {id=80011, name="訓練家跑鞋", amount=1,};

hunter_list[5] = {};
hunter_list[5].target = {}
hunter_list[5].reward = {};
hunter_list[5].reward.item = {};
hunter_list[5].name = "《騷動的野牛山頂》";
hunter_list[5].level_min = 30;
hunter_list[5].level_max = 130;
hunter_list[5].limit = 5;
hunter_list[5].target[1] = {};
hunter_list[5].target[1].name = "爆炸頭水牛";
hunter_list[5].target[1].amount = 30;
hunter_list[5].reward.gold = 2500;
hunter_list[5].reward.lp = 0;
hunter_list[5].reward.fp = 0;
hunter_list[5].reward.ep = 2000;
hunter_list[5].reward.item[1] = {id=80010, name="訓練家夾克", amount=1,};

hunter_list[6] = {};
hunter_list[6].target = {}
hunter_list[6].reward = {};
hunter_list[6].reward.item = {};
hunter_list[6].name = "《遺跡中的遠古守衛》";
hunter_list[6].level_min = 35;
hunter_list[6].level_max = 130;
hunter_list[6].limit = 2;
hunter_list[6].target[1] = {};
hunter_list[6].target[1].name = "青銅鐘";
hunter_list[6].target[1].amount = 50;
hunter_list[6].reward.gold = 3000;
hunter_list[6].reward.lp = 0;
hunter_list[6].reward.fp = 0;
hunter_list[6].reward.ep = 2500;
hunter_list[6].reward.item[1] = {id=17901, name="[未綁定]行動模式卡牌", amount=2,};

hunter_list[7] = {};
hunter_list[7].target = {}
hunter_list[7].reward = {};
hunter_list[7].reward.item = {};
hunter_list[7].name = "《研究所的危險植物》";
hunter_list[7].level_min = 50;
hunter_list[7].level_max = 130;
hunter_list[7].limit = 10;
hunter_list[7].target[1] = {};
hunter_list[7].target[1].name = "刺球仙人掌";
hunter_list[7].target[1].amount = 10;
hunter_list[7].reward.gold = 2000;
hunter_list[7].reward.lp = 0;
hunter_list[7].reward.fp = 0;
hunter_list[7].reward.ep = 1000;
hunter_list[7].reward.item[1] = {id=70264, name="古森木節", amount=20,};

hunter_list[8] = {};
hunter_list[8].target = {}
hunter_list[8].reward = {};
hunter_list[8].reward.item = {};
hunter_list[8].name = "《研究所的人形兵器》";
hunter_list[8].level_min = 50;
hunter_list[8].level_max = 130;
hunter_list[8].limit = 10;
hunter_list[8].target[1] = {};
hunter_list[8].target[1].name = "劈斬司令";
hunter_list[8].target[1].amount = 10;
hunter_list[8].reward.gold = 2000;
hunter_list[8].reward.lp = 0;
hunter_list[8].reward.fp = 0;
hunter_list[8].reward.ep = 1000;
hunter_list[8].reward.item[1] = {id=70268, name="狩獵之牙", amount=20,};

hunter_list[9] = {};
hunter_list[9].target = {}
hunter_list[9].reward = {};
hunter_list[9].reward.item = {};
hunter_list[9].name = "《研究所的生命起源》";
hunter_list[9].level_min = 50;
hunter_list[9].level_max = 130;
hunter_list[9].limit = 10;
hunter_list[9].target[1] = {};
hunter_list[9].target[1].name = "肋骨海龜";
hunter_list[9].target[1].amount = 10;
hunter_list[9].reward.gold = 2000;
hunter_list[9].reward.lp = 0;
hunter_list[9].reward.fp = 0;
hunter_list[9].reward.ep = 1000;
hunter_list[9].reward.item[1] = {id=70272, name="古代礦片", amount=20,};
...
function Module:onLoad()
	...
	self.hunterNPC = self:NPC_createNormal('芙蕾雅女神',98972,{x=40, y=36, mapType=0, map=20311, direction=0})
...
function Module:click(npc,player,_seqno,_select,_data)--窗口中点击触发
	...
	if _select > 0 then
		...
		elseif (_seqno==3000 and _select == CONST.按钮_是) then
			...
			local exploreExp = exploreExp + hunter_list[quest].reward.ep;
...
function hunter_action_reward_generate(quest)
	...
	if( hunter_list[quest].reward.ep ~= 0)then
		msg = msg .. "探索經驗×".. hunter_list[quest].reward.ep.." ";
	end
	for i = 1, #hunter_list[quest].reward.item do
