...
warp_map_name[1] = "道館挑戰";
warp_map_point[1] = {80020,44,55};
warp_map_lvlimit[1] = 50;
warp_map_payfor[1] = 5000;
warp_map_count_Max[1] = 3;

warp_map_name[2] = "玩家對戰";
warp_map_point[2] = {80021,26,55};
warp_map_lvlimit[2] = 50;
warp_map_payfor[2] = 2000;
warp_map_count_Max[2] = 5;

warp_map_name[3] = "七大罪魔女";
warp_map_point[3] = {27851,9,12};
warp_map_lvlimit[3] = 100;
warp_map_payfor[3] = 5000;
warp_map_count_Max[3] = 5;
------------------------------------------------------------------------------------------------------------------------
--功能函数
...
function Module:onLoad()
	self:logInfo('load')
	local warpNPC = self:NPC_createNormal('副本管理员',14063,{x=92, y=96, mapType=0, map=80010, direction=4})
