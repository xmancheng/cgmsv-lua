...
function Module:onLoad()
  self:logInfo('load');
  self.DIYerNPC = self:NPC_createNormal('組合工作台', 400222, { x = 12, y = 30, mapType = 0, map = 20313, direction = 0 });
