-- ============================================================================
-- EquipForgeClientUI.lua｜可讀性整理版
-- 版本原則：僅整理結構與註解，不改變既有函式、協議、參數、資料格式與執行邏輯。
-- 搜尋方式：可使用 [GEM] / [ENHANCE] / [BANK] / [POTENTIAL] / [HOVER] 等標籤快速定位。
-- ============================================================================
-- 功能目錄：
--   01 LIFECYCLE：初始化與封包回應
--   02-03 TAB：裝備／鑲嵌／潛能分頁
--   04-05 HOVER：統一 Tooltip 與品質顏色
--   06 POTENTIAL：潛能 UI 與操作
--   07-09 PANEL/BAG/EQUIP：主介面與格子建立
--   10/13 BANK：銀行
--   11 PARTY：隊員與寵物
--   12 REPAIR：修理
--   14-15 HOVER-EVENT/DRAG-DROP：格子互動
--   16 RENDER：圖示與寶石角標
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- [04][HOVER] 統一裝備 Tooltip、潛能快取與懸停狀態
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- [05][HOVER-UI] Tooltip 控件建立、內容排版與品質顏色
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- [10][BANK-UI] 銀行介面、銀行格與銀行 Tooltip
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- [14][HOVER-EVENT] 背包／身上裝備／強化槽 Hover 與 Click
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- [15][DRAG-DROP] 背包拖曳、雙擊、裝備格與強化格操作
-- ----------------------------------------------------------------------------
