...
--     五	三	一	二	四
--     十	八	六	七	九
EnemySet[1] = {360092, 0, 0, 0, 0, 360071, 360017, 360018, 0, 0}--0代表没有怪
...
------------随机NPC设置
local Pos = {{"魔界小兵",101800,1000,242,86,4},{"魔界兵长",101801,1000,242,90,0},{"魔界大军",117024,1000,244,88,2}}--名字不能一样
