...
BondImage_List[1] = {{700101,700102,700103},60,10,CONST.战属_攻增,-10};		--形象组合、几率、敌我(10,0)、战属、增减数值%
BondImage_List[2] = {{700104,700105,700106},60,10,CONST.战属_攻增,-10};
BondImage_List[3] = {{700107,700108,700109},60,10,CONST.战属_防增,-10};
BondImage_List[4] = {{700110,700111,700112},60,10,CONST.战属_防增,-10};
BondImage_List[5] = {{700113,700114,700115},60,10,CONST.战属_敏增,-10};
BondImage_List[6] = {{700116,700117,700118},60,10,CONST.战属_敏增,-10};
BondImage_List[7] = {{700119,700120,700121},60,0,CONST.战属_攻增,10};
