...
BondImage_List[1] = {{120032,120042,120289},60,10,CONST.战属_攻增,-10};		--形象组合、几率、敌我(10,0)、战属、增减数值%
BondImage_List[2] = {{120265,120197,120250},60,10,CONST.战属_攻增,-10};
BondImage_List[3] = {{120044,120054,120309},60,10,CONST.战属_防增,-10};
BondImage_List[4] = {{120310,120306,120227},60,10,CONST.战属_防增,-10};
BondImage_List[5] = {{120312,120045,120246},60,10,CONST.战属_敏增,-10};
BondImage_List[6] = {{120284,120301,120237},60,10,CONST.战属_敏增,-10};
BondImage_List[7] = {{120043,120081,120085},60,0,CONST.战属_攻增,10};
