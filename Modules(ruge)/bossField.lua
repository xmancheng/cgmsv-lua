...
------------------------------------------------------
local Arcobaleno = { 9021,9023,9042,102125,5050,12000,12100,12003,12004,12022,12023,12027,12028, }	--EnemyId
...
local restraintMap_Enemy_First = {
    { 5050, },	--大空属性
    { 102125,12000,12003,12004,12022,12023, },	--岚属性
    { 12100, },	--雨属性
    {  },	--云属性
    { 9023,9042, },	--晴属性
    { 9021, },	--雷属性
...
local restraintMap_Enemy_Second = {
    { 9021,12000,12022,12023, },	--大空属性
    { 9042, },	--岚属性
    { 9023,12100,12027,12028, },	--雨属性
    {  },	--云属性
    {  },	--晴属性
    { 102125,5050,12003,12004, },	--雷属性
    {  },	--雾属性
  }	--EnemyId
...
function Module:OnbattleStartEventCallback(battleIndex)
         for i=10, 19 do
              ...
              elseif enemy>=0 and Char.IsEnemy(enemy) and CheckInTable(Arcobaleno,enemyId)==true then
                  ...
                  --Char.SetData(enemy,509,139010);	--坐騎
                  --Char.SetData(enemy,533,139038);	--頭飾
                  if Char.GetData(player,CONST.对象_对战开关) == 1  then
