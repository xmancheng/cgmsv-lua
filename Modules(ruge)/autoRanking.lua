...
function Module:onLoad()
  ...
  rankingNPC = self:NPC_createNormal('寶可夢訓練家對戰', 11394, { map = 7351, x = 26, y = 37, direction = 4, mapType = 0 })
...
function TrainerBattle_LoopEvent(rankingNPC)
	...
	elseif (os.date("%X",os.time())=="20:30:00") then
		--swjjcStart(npc);
		if (awardnpc==nil) then
			awardnpc = Module:NPC_createNormal( '淘汰參加獎', 17092, { map = 25291, x = 25, y = 24, direction = 6, mapType = 0 })
