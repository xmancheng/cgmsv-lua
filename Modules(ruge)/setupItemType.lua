...
function Module:onLoad()
  ...
  local itemType = {
    ...
    { type=66, name="魔劍", defaultImage=20075, place=3, flags=0, job=2011, level=10 },
    { type=67, name="陷阱", defaultImage=27938, place=3, flags=0, job=2021, level=10 },
    { type=68, name="書籍", defaultImage=27446, place=3, flags=0, job=2041, level=10 },
    { type=69, name="風魔", defaultImage=99521, place=3, flags=0, job=2031, level=10 },
    { type=70, name="拳套", defaultImage=21303, place=2, flags=128, job=2031, level=10 },
    --{ type=70, name="拳套", defaultImage=21303, place=2, flags=128, job=145, level=10 },
  }
