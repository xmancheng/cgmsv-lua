...
warp_map_name[1] = "海之窟";
warp_map_point[1] = {20262,41,4};
warp_map_lvlimit[1] = 80;
warp_map_payfor[1] = 5000;
warp_map_count_Max[1] = 3;

warp_map_name[2] = "陸之窟";
warp_map_point[2] = {20263,10,4};
warp_map_lvlimit[2] = 80;
warp_map_payfor[2] = 5000;
...
function Module:onLoad()
	self:logInfo('load')
	local warpNPC = self:NPC_createNormal('副本管理员',14063,{x=82, y=49, mapType=0, map=7351, direction=4})
