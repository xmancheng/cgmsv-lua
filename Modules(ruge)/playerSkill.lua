...
local imageRateTable = {
             ...
             { ImageType=2, imageId=106552, ac_val=1.05, mc_val=1.00, adef_val=1.00, mdef_val=1.00},           --增加物理伤害5%
             { ImageType=3, imageId=106527, ac_val=1.00, mc_val=1.00, adef_val=0.95, mdef_val=1.00},           --减轻物理伤害5%
             { ImageType=4, imageId=106475, ac_val=1.05, mc_val=1.00, adef_val=1.00, mdef_val=1.00},           --增加物理伤害5%
             { ImageType=5, imageId=106727, ac_val=1.00, mc_val=1.00, adef_val=1.00, mdef_val=0.95},           --减轻魔法伤害5%
             { ImageType=6, imageId=106627, ac_val=1.00, mc_val=1.05, adef_val=1.00, mdef_val=1.00},           --增加魔法伤害5%
}
