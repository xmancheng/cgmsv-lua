...
Pos[5] = {{"柳橙南瓜灯",104685,38190,70,134,0,EnemySet[7],16,BaseLevelSet[7]},{"暗红南瓜灯",104686,38190,71,115,4,EnemySet[8],17,BaseLevelSet[8]},{"亮黄南瓜灯",104398,38190,86,111,1,EnemySet[9],18,BaseLevelSet[9]},{"深绿南瓜灯",104399,38190,101,115,2,EnemySet[10],19,BaseLevelSet[10]}}
Pos[6] = {{"柳橙南瓜灯",104685,38190,85,91,0,EnemySet[7],20,BaseLevelSet[7]},{"暗红南瓜灯",104686,38190,69,99,4,EnemySet[8],21,BaseLevelSet[8]},{"亮黄南瓜灯",104398,38190,100,86,1,EnemySet[9],22,BaseLevelSet[9]},{"深绿南瓜灯",104399,38190,83,72,2,EnemySet[10],23,BaseLevelSet[10]}}
Pos[7] = {{"柳橙南瓜灯",104685,38190,117,105,0,EnemySet[7],24,BaseLevelSet[7]},{"暗红南瓜灯",104686,38190,103,100,4,EnemySet[8],25,BaseLevelSet[8]},{"亮黄南瓜灯",104398,38190,121,113,1,EnemySet[9],26,BaseLevelSet[9]},{"深绿南瓜灯",104399,38190,103,130,2,EnemySet[10],27,BaseLevelSet[10]}}
Pos[8] = {{"巨大万圣南瓜",104937,38190,114,81,6,EnemySet[11],61,BaseLevelSet[11]}}
...
Pos[9] = {{"果酸粽小子",104759,38304,51,76,0,EnemySet[12],28,BaseLevelSet[12]},{"麻辣粽小子",104760,38304,34,61,4,EnemySet[13],29,BaseLevelSet[13]},{"药苦粽小子",104761,38304,64,81,1,EnemySet[14],30,BaseLevelSet[14]},{"瓜甜粽小子",104762,38304,78,75,2,EnemySet[15],31,BaseLevelSet[15]}}
Pos[10] = {{"果酸粽小子",104759,38304,66,96,0,EnemySet[12],32,BaseLevelSet[12]},{"麻辣粽小子",104760,38304,78,99,4,EnemySet[13],33,BaseLevelSet[13]},{"药苦粽小子",104761,38304,93,88,1,EnemySet[14],34,BaseLevelSet[14]},{"瓜甜粽小子",104762,38304,87,70,2,EnemySet[15],35,BaseLevelSet[15]}}
Pos[11] = {{"果酸粽小子",104759,38304,71,49,0,EnemySet[12],36,BaseLevelSet[12]},{"麻辣粽小子",104760,38304,54,49,4,EnemySet[13],37,BaseLevelSet[13]},{"药苦粽小子",104761,38304,70,32,1,EnemySet[14],38,BaseLevelSet[14]},{"瓜甜粽小子",104762,38304,57,32,2,EnemySet[15],39,BaseLevelSet[15]}}
Pos[12] = {{"端午划龙舟",104758,38304,67,67,5,EnemySet[16],62,BaseLevelSet[16]}}
...
Pos[13] = {{"绿叶灵",104680,38191,97,114,0,EnemySet[17],40,BaseLevelSet[17]},{"红叶灵",104681,38191,103,147,4,EnemySet[18],41,BaseLevelSet[18]},{"魔叶灵",104682,38191,102,154,1,EnemySet[19],42,BaseLevelSet[19]},{"蓝叶灵",104683,38191,91,157,2,EnemySet[20],43,BaseLevelSet[20]},{"黄叶灵",104684,38191,93,147,5,EnemySet[21],44,BaseLevelSet[21]}}
Pos[14] = {{"绿叶灵",104680,38191,67,113,0,EnemySet[17],45,BaseLevelSet[17]},{"红叶灵",104681,38191,71,117,4,EnemySet[18],46,BaseLevelSet[18]},{"魔叶灵",104682,38191,57,120,1,EnemySet[19],47,BaseLevelSet[19]},{"蓝叶灵",104683,38191,69,128,2,EnemySet[20],48,BaseLevelSet[20]},{"黄叶灵",104684,38191,63,133,5,EnemySet[21],49,BaseLevelSet[21]}}
Pos[15] = {{"绿叶灵",104680,38191,104,76,0,EnemySet[17],50,BaseLevelSet[17]},{"红叶灵",104681,38191,107,82,4,EnemySet[18],51,BaseLevelSet[18]},{"魔叶灵",104682,38191,104,90,1,EnemySet[19],52,BaseLevelSet[19]},{"蓝叶灵",104683,38191,95,83,2,EnemySet[20],53,BaseLevelSet[20]},{"黄叶灵",104684,38191,106,98,5,EnemySet[21],54,BaseLevelSet[21]}}
Pos[16] = {{"绿叶灵",104680,38191,127,89,0,EnemySet[17],55,BaseLevelSet[17]},{"红叶灵",104681,38191,131,98,4,EnemySet[18],56,BaseLevelSet[18]},{"魔叶灵",104682,38191,131,106,1,EnemySet[19],57,BaseLevelSet[19]},{"蓝叶灵",104683,38191,127,116,2,EnemySet[20],58,BaseLevelSet[20]},{"黄叶灵",104684,38191,118,106,5,EnemySet[21],59,BaseLevelSet[21]}}
...
function initActivityScriptNpc()
	if (ActivityScriptNps == nil) then
		...
		Char.SetData(ActivityScriptNps,%对象_原名%,"每日活动副本");
	...
	if (ActivityScriptNpsB == nil) then
		...
		Char.SetData(ActivityScriptNpsB,%对象_原名%,"奖励发放员");
	...
	if (ActivityScriptNpsC == nil) then
		...
		Char.SetData(ActivityScriptNpsC,%对象_原名%,"明怪设置");
...
function ActivityScriptMsg(_me,_tome)
	if (NLG.CanTalk(_me,_tome) == true) then
		...
		for i=2,5 do
			...
			str_ChangeWindow = str_ChangeWindow .. "<"..script_map_payfor[i].."G>".." "..script_map_name[i].." 剩余".."<"..tcount..">次".."\\n";
...
function ActivityNpc_BattleWin(_BattleIndex, _NpcIndex)
		...
		if tPlayerIndex>=0 and Char.GetData(tPlayerIndex,%对象_类型%)==1 then
			if(tImage == 104845 or tImage == 104846 or tImage == 104847 or tImage == 104848 or tImage == 104849) then
				...
				NLG.SystemMessage(tPlayerIndex, "[系统]击败了"..Char.GetData(_NpcIndex, %对象_原名%).."获得10分,累积达到"..getamountless_5.."分")
				...
				if (getamountless_5 >= 100)then
					NLG.SystemMessage(tPlayerIndex, "[系统]《蛋糕岛冒险》菁英强敌即将出现！")
				end
			end
			if(tImage == 104313) then
				NLG.SystemMessage(tPlayerIndex, "[系统]《蛋糕岛冒险》副本已经结束！")
			...
			if(tImage == 104686 or tImage == 104685 or tImage == 104399 or tImage == 104398) then
				...
				NLG.SystemMessage(tPlayerIndex, "[系统]击败了"..Char.GetData(_NpcIndex, %对象_原名%).."获得5分,累积达到"..getamountless_4.."分")
				...
				if (getamountless_4 >= 40)then
					NLG.SystemMessage(tPlayerIndex, "[系统]《南瓜大进击》菁英强敌即将出现！")
				end
			end
			if(tImage == 104937) then
			...
			if(tImage == 104759 or tImage == 104760 or tImage == 104761 or tImage == 104762) then
				...
				NLG.SystemMessage(tPlayerIndex, "[系统]击败了"..Char.GetData(_NpcIndex, %对象_原名%).."获得5分,累积达到"..getamountless_3.."分")
			...
			if(tImage == 104680 or tImage == 104681 or tImage == 104682 or tImage == 104683 or tImage == 104684) then
				...
				NLG.SystemMessage(tPlayerIndex, "[系统]击败了"..Char.GetData(_NpcIndex, %对象_原名%).."获得1分,累积达到"..getamountless_2.."分")
				...
				if (getamountless_2 >= 100)then
					NLG.SystemMessage(tPlayerIndex, "[系统]《仙境小妖森》副本已经结束！")
